...
INSTALL_KUBECTL_BOOLEAN=$6
    ...
    # If missing keys do: sudo apt-key adv --keyserver keyserver.ubuntu.com --recv-keys KEYKEYKEYKEYKEY // Thanks to: https://chrisjean.com/fix-apt-get-update-the-following-signatures-couldnt-be-verified-because-the-public-key-is-not-available/

    sudo apt-get install -y mongodb-org
    sudo systemctl start mongod
    sudo systemctl enable mongod
    sudo systemctl status mongod
    # See also: sudo systemctl stop mongod, sudo systemctl start mongod
